...
/**
 * This is the item provider adapter for a {@link homework4_ecommerce_project.EntityRelationships.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntityRelationshipsPackage.Literals.ATTRIBUTE__TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Attribute.class)) {
			case EntityRelationshipsPackage.ATTRIBUTE__TYPE:
