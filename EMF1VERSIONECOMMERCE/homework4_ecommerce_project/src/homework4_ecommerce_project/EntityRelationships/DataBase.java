...
public interface DataBase extends NamedElement {
	 ...
	 * @generated
	 */
	 default int NmEntities(){
		 int totalAttributes = 0;

		    // Loop through each entity and add the number of attributes it has
		    for (Entity entity : getEntities()) {
		        totalAttributes += entity.getAttributes().size(); // Assuming getAttributes() returns a list of attributes
		    }
