 ...
 * </p>
 * <ul>
 *   <li>{@link homework4_ecommerce_project.EntityRelationships.impl.DataBaseImpl#getEntities <em>Entities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataBaseImpl extends NamedElementImpl implements DataBase {
	...
	protected EClass eStaticClass() {
		return EntityRelationshipsPackage.Literals.DATA_BASE;
	}
	...
	public EList<Entity> getEntities() {
		if (entities == null) {
			entities = new EObjectContainmentEList<Entity>(Entity.class, this, EntityRelationshipsPackage.DATA_BASE__ENTITIES);
		}
		return entities;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case EntityRelationshipsPackage.DATA_BASE___NM_ENTITIES:
				return NmEntities();
		}
